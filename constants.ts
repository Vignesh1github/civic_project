...
export const MOCK_COMPLAINTS: Complaint[] = [
  ...
  },
  {
    ...
    imageBase64: null,
    location: { latitude: 28.6339, longitude: 77.2290, address: 'Main St Connector' },
    status: 'Resolved',
    createdAt: Date.now() - 86400000 * 10,
    aiAnalysis: {
      category: 'Roads & Potholes',
      priority: 'High',
      summary: 'Hazardous pothole disrupting traffic flow.',
      suggestedAction: 'Fill and patch road surface.'
    }
  }
];
